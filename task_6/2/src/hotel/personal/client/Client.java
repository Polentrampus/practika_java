...
public class Client extends Person {
    ...
    public static class ClientBuilder extends Person.Builder<ClientBuilder>{
        ...
        @Override
        public Client build() throws HotelException {
            if (departureDate == null || checkOutDate == null) {
                throw new HotelException("Даты заезда и выезда должны быть указаны");
            }
            if (departureDate.isAfter(checkOutDate)) {
                throw new HotelException("Дата заезда не может быть позже даты выезда");
            }
